...
String dbName = "flyawaydb?characterEncoding=utf8";
String userId = "root";
...
<body>
	<div>
		...
		<p align="center">
			<span><strong> You Searched flights from <%=Search.source%>
					to <%=Search.destination%> <br> Date of travel : <%=Search.date%>
					(<%=Search.day%>) <br> No of travelers : <%=Search.persons%> <br>
		</p>
		<table>
			<thead>
				<tr>
			...
			<tbody>
				...
				<tr bgcolor="#F5F5F5">
					...
					<td>
						<form action="${pageContext.request.contextPath}/BookFlight.jsp"
							method="post">
							<input type="hidden" id="name" name="name"
								value="<%=resultSet.getString("Name")%>"> <input
								type="hidden" id="ticket_price" name="ticket_price"
								value="<%=resultSet.getString("TicketPrice")%>"> <input
